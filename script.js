...
const questions = {
    '1': {
        text: "هاي حبوبي! عندي مفاجأة صغيرة ليوم ميلادك، حاب تشوفها؟",
        buttons: [
            { text: "يلا", next: '2' },
...
سنه صعبه اه بس انت كُنت قدها شو مفكر حسيبك لحالك لا هيه كانت فتره راحه لألك مع انه انا ما كُنت مقتنعه فيها بتمنى انك تكون مرتاح معي.
